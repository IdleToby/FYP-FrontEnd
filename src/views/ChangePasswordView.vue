      ...
      >
        ...
        <el-form-item prop="oldPassword">
          <el-input
            ...
            size="default"
            show-password
            v-model="changePasswordUser.oldPassword"
        ...
        <el-form-item>
          ...
          <div class=" w-full text-center">
            <el-text>Or you can</el-text>
          </div>
          <div class=" w-full text-center">
            <el-button type="danger" @click="del(changePasswordUser.userId)">Delete Account</el-button>
          </div>
        </el-form-item>
      </el-form>
    </div>
...
function validatePass(rule, value, callback) {
  if (
    changePasswordUser.value.newPassword !== changePasswordUser.value.confirmPassword &&
    changePasswordUser.value.confirmPassword !== ''
  ) {
...
function del(id) {
  ElMessageBox.confirm('Are you sure to delete your account?', 'Warning', {
